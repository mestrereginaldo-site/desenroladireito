      ...
      <div className="container mx-auto px-4">
        <div className="max-w-4xl">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            <Link href="/artigos">
              <Button size="lg" variant="secondary" className="w-full sm:w-auto gap-2" data-testid="button-ver-artigos">
                <FaBookOpen />
                Ver Artigos
              </Button>
            </Link>
            <Link href="/artigos">
              <Button 
                size="lg" 
                variant="outline" 
                className="w-full sm:w-auto gap-2 bg-transparent border-white text-white hover:bg-white hover:text-primary"
                data-testid="button-publicacoes-recentes"
              >
                <FaClock />
